...
trait TaxProfileOperations
{
    public function upsertProfile(array $data, int $actorUserId): array
    {
        ...
        $payload = [
            ...
            'taxpayer_type' => (int) ($data['taxpayer_type'] ?? 2),
            ...
            'gateway_config_json' => json_encode($config, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_THROW_ON_ERROR),
    ...
    {
        return $this->requireProfile($this->positiveId($profileId, 'profile_id'));
    }
